...
class SequenceController extends Controller
{
    ...
    public function subscribe(Request $request, $sequenceId)
    {
        ...
        $processPerRequest = (int)apply_filters('fluentcrm_process_subscribers_per_request', 200);
    ...
    public function handleBulkAction(Request $request)
    {
        ...
        return $this->sendSuccess([
            'message' => __('Selected Sequences has been deleted permanently', 'fluent-crm'),
        ]);
    }
}
