...
class AutomationConditions
{
    ...
    public function assessAutomationConditions($result, $conditions, $subscriber)
    {
        ...
        if (Commerce::isEnabled('woo')) {
            ...
            $commerceProps = ['purchased_items', 'total_order_count', 'total_order_value', 'last_order_date', 'first_order_date', 'purchased_categories', 'purchased_tags', 'commerce_coupons'];
