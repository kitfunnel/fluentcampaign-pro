...
class DeepIntegration
{
    ...
    {
        add_filter('fluentcrm_woo_purchase_sidebar_html', array($this, 'pushCommerceWidget'), 10, 3);
        add_filter('fluentcrm_contact_purchase_stat_woo', array($this, 'getPurchaseStat'), 10, 2);
        ...
        add_filter('fluentcrm_advanced_report_providers', function ($providers) {
            ...
            if (apply_filters('fluentcrm_user_can_view_woo_report', current_user_can('view_woocommerce_reports'))) {
                $providers['woo'] = [
