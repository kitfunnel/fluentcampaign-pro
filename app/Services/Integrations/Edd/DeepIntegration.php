...
class DeepIntegration
{
    public function init()
    {
        ...
        add_filter('fluentcrm_edd_purchase_sidebar_html', array($this, 'pushCommerceWidget'), 10, 3);
        add_filter('fluentcrm_contact_purchase_stat_edd', array($this, 'getPurchaseStat'), 10, 2);
        ...
        add_filter('fluentcrm_advanced_report_providers', function ($providers) {
            ...
            if (apply_filters('fluentcrm_user_can_view_edd_report', current_user_can('view_shop_sensitive_data'))) {
                $providers['edd'] = [
                    'title' => 'EDD'
                ];
            }
