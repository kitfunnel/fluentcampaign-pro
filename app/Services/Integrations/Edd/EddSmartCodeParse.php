...
class EddSmartCodeParse
{
    ...
    {
        add_filter('fluentcrm_smartcode_fallback_callback_edd_customer', array($this, 'parseCustomer'), 10, 4);
        add_filter('fluentcrm_smartcode_fallback_callback_edd_order', array($this, 'parseCurrentOrder'), 10, 4);
        add_filter('fluentcrm_smartcode_fallback_callback_edd_license', array($this, 'parseLicenseCodes'), 10, 4);
