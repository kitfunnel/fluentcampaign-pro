...
class RCPMembershipExpireTrigger extends BaseTrigger
{
    public function __construct()
    {
        $this->triggerName = 'rcp_transition_membership_status_expired';
        $this->priority = 15;
        $this->actionArgNum = 2;
        parent::__construct();
    }
    ...
    {
        return [
            'title'     => __('Membership is expired', 'fluentcampaign-pro'),
            'sub_title' => __('This funnel will start when a membership has been expired', 'fluentcampaign-pro'),
            'fields'    => [
                'subscription_status' => [
    ...
    public function getConditionFields($funnel)
    {
        return [
            'membership_ids'    => [
                ...
                'inline_help' => __('Keep it blank to run to any Level Expiration', 'fluentcampaign-pro')
            ],
            'run_multiple' => [
                'type'        => 'yes_no_check',
                'label'       => '',
    ...
    {
        $membership = rcp_get_membership($originalArgs[1]);
