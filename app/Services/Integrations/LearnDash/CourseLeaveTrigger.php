...
class CourseLeaveTrigger extends BaseTrigger
{
    ...
    {
        $this->triggerName = 'simulated_learndash_update_course_removed';
    ...
    {
        return [
            'title'     => __('Leave from a Course', 'fluentcampaign-pro'),
            'sub_title' => __('This Funnel will start when a student is leave from a course', 'fluentcampaign-pro'),
            'fields'    => [
                'subscription_status'      => [
