...
class AddToMembershipAction extends BaseAction
{
    ...
    public function getBlock()
    {
        return [
            ...
            'title'       => __('Enroll To a Membership Group', 'fluent-crm'),
            'description' => __('Enroll the contact to a specific LMS Membership Group', 'fluent-crm'),
    ...
    public function getBlockFields()
    {
        return [
            'title'     => __('Enroll To a Membership Group', 'fluent-crm'),
            'sub_title' => __('Enroll the contact to a specific LMS Membership Group', 'fluent-crm'),
            'fields'    => [
                'group_id'           => [
                    'type'        => 'rest_selector',
                    ...
                    'is_multiple' => false,
                    'clearable'   => true,
                    'label'       => __('Select LifterLMS Membership Group to Enroll', 'fluent-crm'),
                    'placeholder' => __('Select LifterLMS Membership Group', 'fluent-crm')
                ],
                'skip_for_public'    => [
                    'type'        => 'yes_no_check',
