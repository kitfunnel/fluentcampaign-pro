...
class LessonCompletedTrigger extends BaseTrigger
{
    ...
    {
        $this->triggerName = 'tutor_lesson_completed_after';
        $this->priority = 12;
        $this->actionArgNum = 2;
        parent::__construct();
    }
    ...
    {
        return [
            'title'     => __('Student completes a Lesson in TutorLMS', 'fluentcampaign-pro'),
    ...
    public function getConditionFields($funnel)
    {
        return [
            ...
            'lesson_ids'  => [
                ...
                'options'     => Helper::getLessons(),
                'inline_help' => __('Keep it blank to run to any Lesson Complete', 'fluentcampaign-pro')
            ],
            'run_multiple'       => [
                'type'        => 'yes_no_check',
                'label'       => '',
