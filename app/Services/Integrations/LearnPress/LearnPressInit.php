        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    ...
                    <select id="fluentcrm_add_enroll_tags" placeholder="<?php esc_attr_e('Select Tags', 'fluentcampaign-pro'); ?>" style="width:100%;"
                    ...
                    <span class="description"><?php esc_html_e('Apply these tags on course enrollment', 'fluentcampaign-pro'); ?></span>
                </td>
            </tr>
            <tr>
                <th><label
                ...
                <td>
                    <select id="fluentcrm_add_completed_tags" placeholder="<?php esc_attr_e('Select Tags', 'fluentcampaign-pro'); ?>" style="width:100%;"
                            class="fc_multi_select"
                    ...
                    <span class="description"><?php esc_html_e('Apply these tags on course completion', 'fluentcampaign-pro'); ?></span>
                </td>
            </tr>
        </table>
        <?php
